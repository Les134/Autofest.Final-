...
export default function App() {
  ...
  return (
    <div style={{padding:20}}>
      ...
      <div>
        <label>Gender: </label>
        <button onClick={()=>setGender("Male")} style={{background: gender==="Male"?"blue":""}}>Male</button>
        <button onClick={()=>setGender("Female")} style={{background: gender==="Female"?"blue":""}}>Female</button>
      </div>
